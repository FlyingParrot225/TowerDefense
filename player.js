class Player{
    ...
    draw(){
        ...
        ctx.fillStyle = "gray"
        ctx.fillRect(this.turretX,this.turretY,this.turretWidth, -this.turretHeight/2);
        ctx.strokeRect(this.turretX,this.turretY,this.turretWidth, -this.turretHeight/2);
        ctx.restore();
        ctx.fillStyle = "black";
    }
    update(){
